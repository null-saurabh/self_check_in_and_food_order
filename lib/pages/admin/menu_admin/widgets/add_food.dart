...
class AddFoodItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final AddFoodItemController controller = Get.put(AddFoodItemController(item: item));
    ...
    return Container(
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            Center(
              child: Text("Add Food Item", style: AppWidget.heading3BoldTextStyle()),
            ),
                ...
                child: Column(
                  children: [
                    ...
                    Obx(() { return AppDropDown(
                      ...
                      onChange: (value) => controller.selectedCategory.value = value,
            ...
            Row(
              ...
              children: [
                ...
                AppElevatedButton(
                  ...
                  child:  Text(isEdit ? "Save" :"Add",style: TextStyle(color: Colors.white),),
                ),
              ],
            ),
          ],
